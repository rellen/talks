defmodule PromExDemo.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule PromExDemoWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :prom_ex_demo

       ...

       plug PromEx.Plug, prom_ex_module: PromExDemo.PromEx
  ...
  use PromEx, otp_app: :prom_ex_demo
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: PromExDemoWeb.Router, endpoint: PromExDemoWeb.Endpoint},
      {Plugins.Ecto, otp_app: :prom_ex_demo},
      # Plugins.Oban,
      Plugins.PhoenixLiveView
      # Plugins.Absinthe

      # Add your own PromEx metrics plugins
      # PromExDemo.Users.PromExPlugin
    ]
  end
  ...
  def dashboard_assigns do
    [
      datasource_id: Application.get_env(:prom_ex_demo, :grafana_datasource_id),
  ...
  def dashboards do
    [
      ...
      # {:prom_ex_demo, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
